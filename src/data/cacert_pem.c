/* cacert_pem.c — GENERATED FILE. Do not edit by hand.
 * Rebuild from src/data/cacert.pem via: tools/gen_cacert.sh
 * Source of truth: https://curl.se/ca/cacert.pem (Mozilla CA bundle).
 * Refresh policy: quarterly (see roadmap). */
#include <stddef.h>
const char visage_cacert_pem[] =
"##\n"
...
"-----END CERTIFICATE-----\n"
"";
const size_t visage_cacert_pem_len = sizeof(visage_cacert_pem) - 1;
