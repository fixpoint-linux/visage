...
CORE="$DHALL_C/src/arena.c $DHALL_C/src/lexer.c $DHALL_C/src/parser.c $DHALL_C/src/ast.c $DHALL_C/src/normalize.c $DHALL_C/src/typecheck.c $DHALL_C/src/builtins.c $DHALL_C/src/serialize.c $DHALL_C/src/import.c $DHALL_C/src/bignum.c $DHALL_C/src/sha256.c $DHALL_C/src/http.c"
...
EM_CONFIG="$EMCONF" "$EMCC" $COMMON \
  ...
  $RUNTIME \
  -o "$OUT/visage.js" \
  src/visage-wasm.c src/config.c src/mail.c $CORE
